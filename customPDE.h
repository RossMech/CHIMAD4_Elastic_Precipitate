...
private:
	...
	dealii::Tensor<2,dim> epsilon_0 = userInputs.get_model_constant_rank_2_tensor("epsilon_0");
	dealii::Tensor<2,CIJ_tensor_size> CIJ_part = userInputs.get_model_constant_elasticity_tensor("CIJ_part");
	dealii::Tensor<2,CIJ_tensor_size> CIJ_matr = userInputs.get_model_constant_elasticity_tensor("CIJ_matr");
